        ...
        else
        {
            ...
            if((TiltTopLimit - head_tilt_angle) > (head_tilt_angle - TiltBottomLimit))
            {
                ...
                if(head_pan_angle < -PanLimit) 
                {
                    ...
                    Head::GetInstance()->m_PanAngle = -PanLimit;
                    Head::GetInstance()->m_TiltAngle = TiltTopLimit;

                }
                else 
                {
                    Head::GetInstance()->MoveByAngle(head_pan_angle, TiltBottomLimit);
                    Head::GetInstance()->m_PanAngle = head_pan_angle;
                    Head::GetInstance()->m_TiltAngle = TiltBottomLimit;
                }

                Head::GetInstance()->m_PanAngle = head_pan_angle;
                Head::GetInstance()->m_TiltAngle = head_tilt_angle;
