...
// #ifdef MX28_1024
        ...
        static constexpr double MXMIN_ANGLE = -180.0; // degree
        static constexpr double MXMAX_ANGLE = 180.0; // degree
        static constexpr double MXRATIO_VALUE2ANGLE = 0.088; // 360 / 4096
        static constexpr double MXRATIO_ANGLE2VALUE = 11.378; // 4096 / 360
